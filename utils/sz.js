...
//申论提交答案
function xcxShenlunTijiao(params) {
  return fetch.szfetch(URI, 'xcxShenlunTijiao', params)
}
//申论答案分析
function xcxShenlunAnswer(params) {
  return fetch.szfetch(URI, 'xcxShenlunAnswer', params)
}
...
//新的课程界面
function xcxNewCourse(params){
  return fetch.szfetch(URI, 'xcxNewCourse', params)
}
// //获得打卡主题列表daka 页面 
...
function createCourseOrder(params) {
  return fetch.szfetch(URI, 'xcxcreateCourseOrder', params)
}
...
//专项测评评估报告 
function pigobaogao(params) {
  return fetch.szfetch(URI, 'xcxPigobaogao', params)
}

//专项测评提交答案 
function xcxanswersave(params) {
  return fetch.szfetch(URI, 'xcxAnswerSave', params)
}
//课程模块详情
function xcxNewCourseDetail(params){
  return fetch.szfetch(URI, 'xcxNewCourseDetail', params)
}
//获取收货地址信息
function xcxorderaddress(params) {
  return fetch.szfetch(URI, 'xcxorderaddress', params)
}
